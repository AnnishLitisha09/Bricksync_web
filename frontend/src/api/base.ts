export const BASE_URL = "https://2s01cq2n-5001.inc1.devtunnels.ms/api";
export const FILE_BASE_URL = "https://2s01cq2n-5001.inc1.devtunnels.ms";
export const BASE_URL_NO_API = "https://2s01cq2n-5001.inc1.devtunnels.ms";
